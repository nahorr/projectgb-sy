		...
		<div class="content">
			...
			<div class="row">
		        <div class="col-md-12">
		            <div class="card">
		                <div class="header">
		                  <h4 class="title"><strong>Edit Comment for {{ $student->first_name }} {{ $student->last_name }}</strong> <a class="pull-right"> {{ $group->name }}- {{$term->term}} </a></h4> 
		                </div>
		                <hr style="border-color: #fff;">

			<form class="form-group" action="{{ url('/postCommentUpdate', [Crypt::encrypt($student_comment->student_id), Crypt::encrypt($term->id)] )}}" method="POST">
					{{ csrf_field() }}
                                            ...
                                            <tr>
											    ...
											    <div class="form-group row">
												  ...
												  <div class="well">
												  	...
												  	{{ $student_comment->comment_teacher }}
												  </div>
												  <div class="col-10">
